...
//fragment uniforms
GLint TextureMaterial::_uModelColor = 0;
...
TextureMaterial::TextureMaterial(Texture* pTexture, glm::vec3 pModelColor, float pShininess, std::vector<AbstractLight*>* pLights)
